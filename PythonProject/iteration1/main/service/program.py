...
from PythonProject.itertools import chain
...
class Program:
    ...
    def part_8(self):
        ...
        for i in range(len(self.studentsRepository.studentRawRepo)-1):
            ...
            quiz_poll_DataFrame = pd.read_csv(r"C:\Users\dialajubeh\Documents\CSE3063F20P1_GRP20\PythonProject\iteration1\CSE3063_20201123_Mon_zoom_PollReport.csv - CSE3063_20201123_Mon_zoom_PollReport.csv (1).csv")
            ...
            attendance_poll_DataFrame = pd.read_csv(r"C:\Users\dialajubeh\Documents\CSE3063F20P1_GRP20\PythonProject\iteration1\CSE3063_20201124_Tue_zoom_PollReport.csv - CSE3063_20201124_Tue_zoom_PollReport.csv.csv")
